...
class MainLoop {
	...
	public static function add ($f, $priority = 0) {
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:97: lines 97-108
		if ($priority === null) {
			$priority = 0;
		}
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:98: lines 98-99
		if ($f === null) {
			#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:99: characters 4-9
			throw Exception::thrown("Event function is null");
		}
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:100: characters 3-38
		$e = new MainEvent($f, $priority);
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:101: characters 3-22
		$head = MainLoop::$pending;
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:102: lines 102-103
		if ($head !== null) {
			#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:103: characters 4-17
			$head->prev = $e;
		}
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:104: characters 3-16
		$e->next = $head;
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:105: characters 3-14
		MainLoop::$pending = $e;
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:106: characters 3-25
		MainLoop::injectIntoEventLoop(0);
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:107: characters 3-11
		return $e;
	}
	...
	public static function addThread ($f) {
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:87: characters 3-26
	...
	public static function get_threadCount () {
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:74: characters 3-32
	...
	public static function runInMainThread ($f) {
		#C:\HaxeToolkit\haxe\std/haxe/MainLoop.hx:91: characters 3-32
