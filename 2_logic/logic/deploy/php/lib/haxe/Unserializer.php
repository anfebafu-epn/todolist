...
class Unserializer {
	...
	public static function fastCharAt ($s, $pos) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:496: characters 3-35
		return $s[$pos];
	}
	...
	public static function fastCharCodeAt ($s, $pos) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:488: characters 3-51
		return \ord($s[$pos]);
	}
	...
	public static function fastLength ($s) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:480: characters 3-30
		return \strlen($s);
	}
	...
	public static function fastSubstr ($s, $pos, $length) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:504: characters 3-43
	...
	public static function initCodes () {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:75: characters 3-72
		$codes = new \Array_hx();
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:76: characters 13-17
		$_g = 0;
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:76: characters 17-30
		$_g1 = mb_strlen(Unserializer::$BASE64);
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:76: lines 76-77
		while ($_g < $_g1) {
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:76: characters 13-30
			$i = $_g++;
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:77: characters 4-48
			$codes->offsetSet(\StringTools::fastCodeAt(Unserializer::$BASE64, $i), $i);
		}
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:78: characters 3-15
		return $codes;
	}
	...
	public function get ($p) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:144: characters 10-49
		if ($p >= $this->length) {
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:144: characters 24-25
			return 0;
		} else {
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:144: characters 28-49
	...
	public function getResolver () {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:139: characters 3-18
	...
	public function setResolver ($r) {
		#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:127: lines 127-130
		if ($r === null) {
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:128: characters 15-36
			if (NullResolver::$instance === null) {
				NullResolver::$instance = new NullResolver();
			}
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:128: characters 4-36
			$this->resolver = NullResolver::$instance;
		} else {
			#C:\HaxeToolkit\haxe\std/haxe/Unserializer.hx:130: characters 4-16
			$this->resolver = $r;
		}
	}
