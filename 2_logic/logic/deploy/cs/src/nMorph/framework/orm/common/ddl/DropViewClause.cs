...
namespace nMorph.framework.orm.common.ddl {
	public class DropViewClause : global::haxe.lang.HxObject, global::nMorph.framework.orm.interfaces.IClause {
		
		public DropViewClause(global::haxe.lang.EmptyObject empty) {
		}
		
		
		public DropViewClause(global::nMorph.framework.orm.lang.DDL CurrentDDL, string ViewName) {
			global::nMorph.framework.orm.common.ddl.DropViewClause.__hx_ctor_nMorph_framework_orm_common_ddl_DropViewClause(this, CurrentDDL, ViewName);
		}
		
		
		protected static void __hx_ctor_nMorph_framework_orm_common_ddl_DropViewClause(global::nMorph.framework.orm.common.ddl.DropViewClause __hx_this, global::nMorph.framework.orm.lang.DDL CurrentDDL, string ViewName) {
		...
		public virtual void SCRIPT_PART(string args) {
			unchecked {
				switch (this.CurrentDDL.getCurrentEngine()._hx_index) {
					case 0:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("DROP VIEW \"", this.ViewName), "\""));
						break;
					}
