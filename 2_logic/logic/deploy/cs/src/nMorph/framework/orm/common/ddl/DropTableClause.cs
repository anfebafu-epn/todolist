...
namespace nMorph.framework.orm.common.ddl {
	public class DropTableClause : global::haxe.lang.HxObject, global::nMorph.framework.orm.interfaces.IClause {
		
		public DropTableClause(global::haxe.lang.EmptyObject empty) {
		}
		
		
		public DropTableClause(global::nMorph.framework.orm.lang.DDL CurrentDDL, string TableName) {
			global::nMorph.framework.orm.common.ddl.DropTableClause.__hx_ctor_nMorph_framework_orm_common_ddl_DropTableClause(this, CurrentDDL, TableName);
		}
		
		
		protected static void __hx_ctor_nMorph_framework_orm_common_ddl_DropTableClause(global::nMorph.framework.orm.common.ddl.DropTableClause __hx_this, global::nMorph.framework.orm.lang.DDL CurrentDDL, string TableName) {
		...
		public virtual void SCRIPT_PART(string args) {
			unchecked {
				switch (this.CurrentDDL.getCurrentEngine()._hx_index) {
					case 0:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(" DROP TABLE \"", this.TableName), "\" "));
						break;
					}
