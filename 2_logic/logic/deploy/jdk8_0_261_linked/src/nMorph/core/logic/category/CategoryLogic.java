...
public final class CategoryLogic extends haxe.lang.HxObject
{
	static
	{
		...
		nMorph.core.logic.category.CategoryLogic.__rtti = new String("<class path=\"nMorph.core.logic.category.CategoryLogic\" params=\"\" final=\"1\">\n\t") + 
new String ("<Query public=\"1\" set=\"method\" line=\"32\"><f a=\"\"><c path=\"String\"/></f></Query>\n\t") + 
new String ("<Category_Search public=\"1\" set=\"method\" line=\"38\"><f a=\"SearchTerm\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.core.db.sw_todolist.Category\"/></c>\n</f></Category_Search>\n\t") + 
new String ("<Category_GetByID public=\"1\" set=\"method\" line=\"49\"><f a=\"ID\">\n\t") + 
new String ("<c path=\"nMorph.framework.common.datatypes.UUID\"/>\n\t") + 
new String ("<c path=\"nMorph.core.db.sw_todolist.Category\"/>\n</f></Category_GetByID>\n\t") + 
new String ("<Category_Save public=\"1\" set=\"method\" line=\"57\"><f a=\"UpdatedObj\">\n\t") + 
new String ("<c path=\"nMorph.core.db.sw_todolist.Category\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></Category_Save>\n\t") + 
new String ("<Category_Delete public=\"1\" set=\"method\" line=\"82\"><f a=\"ID\">\n\t") + 
new String ("<c path=\"nMorph.framework.common.datatypes.UUID\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></Category_Delete>\n\t") + 
