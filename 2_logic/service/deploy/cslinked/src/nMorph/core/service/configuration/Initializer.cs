...
namespace nMorph.core.service.configuration {
	public class Initializer : global::haxe.lang.HxObject {
		...
		public Initializer() {
			global::nMorph.core.service.configuration.Initializer.__hx_ctor_nMorph_core_service_configuration_Initializer(this);
		}
		
		
		protected static void __hx_ctor_nMorph_core_service_configuration_Initializer(global::nMorph.core.service.configuration.Initializer __hx_this) {
		}
