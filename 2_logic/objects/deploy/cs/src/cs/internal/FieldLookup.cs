...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 105, 109, 115, 1821933, 4745537, 4846113, 4849249, 4949376, 5144726, 5243965, 5343647, 5393365, 5442204, 5442212, 5443986, 5594513, 5594516, 5741474, 24046298, 42740551, 52644165, 67856200, 67859554, 76061764, 78945784, 87367608, 142301684, 159136996, 221637784, 261031087, 302979532, 312752480, 328878574, 359333139, 407283053, 437335495, 452737314, 480756972, 501039929, 520590566, 520665567, 537630174, 572311959, 598785079, 614073432, 630156697, 724060212, 727112898, 746281503, 834174833, 845179051, 863972113, 865294836, 869834347, 922671056, 946786476, 995006396, 1066783641, 1067353468, 1071652316, 1081380189, 1088942801, 1103412149, 1126920507, 1177754921, 1181037546, 1191633396, 1203028895, 1204816148, 1213952397, 1224901875, 1247875546, 1257164128, 1271070480, 1273207865, 1274465926, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1460447810, 1489662016, 1512997393, 1532710347, 1537812987, 1547539107, 1614780307, 1620824029, 1621420777, 1623148745, 1639293562, 1643164520, 1648581351, 1705629508, 1711741140, 1723805383, 1789265245, 1797611211, 1825849507, 1915412854, 1916009602, 1937159360, 1981972957, 2012934199, 2022294396, 2025055113, 2048392659, 2082663554, 2083500811, 2113708439, 2127021138};
		
		protected static string[] fields = new string[]{"b", "i", "m", "s", "isGlobal", "__a", "add", "arr", "cur", "get", "idx", "key", "len", "map", "max", "min", "pop", "pos", "set", "split", "flags", "match", "stack", "start", "remove", "__previousException", "filter", "resize", "matched", "__nativeException", "get_length", "methodName", "get_native", "iterator", "lastIndexOf", "hasNext", "message", "reverse", "nOccupied", "insert", "length", "addSub", "get_message", "native", "previous", "matchedRight", "array", "replace", "details", "contains", "value", "quotient", "__nativeStack", "get_Name", "Name", "cachedIndex", "toString", "hashes", "__exceptionStack", "splice", "exists", "args", "set_NameModified", "copy", "matchSub", "__skipStack", "join", "keys", "get_stack", "concat", "clear", "next", "push", "keyValueIterator", "matchedPos", "current", "__shiftStack", "size", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "__ownStack", "get_previous", "posInfos", "concatNative", "nBuckets", "className", "offset", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "set_Name", "fileName", "toDynamic", "NameModified", "regex", "get_NameModified", "getDefault", "unwrap", "__get", "__set", "__hx_deleteField", "lineNumber", "modulus", "upperBound", "unshift", "_keys", "shift", "matchedLeft", "addChar", "slice"};
