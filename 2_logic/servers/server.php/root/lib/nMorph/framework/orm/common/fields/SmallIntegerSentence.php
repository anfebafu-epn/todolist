...
class SmallIntegerSentence extends FieldSentence {
	...
	public function __construct ($FieldTable, $FieldName, $Nullable, $IsPrimaryKey) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:16: characters 9-116
		parent::__construct($FieldTable, $FieldName, DBTypeEnum::SMALLINTEGER(), HaxeTypeEnum::INT(), null, null, $Nullable, $IsPrimaryKey);
	}
	...
	public function Different ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:29: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:30: characters 9-68
	...
	public function Equals ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:24: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:25: characters 9-64
	...
	public function IsNotNull () {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:58: characters 9-64
	...
	public function IsNull () {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:54: characters 9-60
	...
	public function LessThan ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:34: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:35: characters 9-67
	...
	public function LessThanAndEquals ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:39: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:40: characters 9-76
	...
	public function MoreThan ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:44: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:45: characters 9-67
	...
	public function MoreThanAndEquals ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:49: characters 9-42
		$this->ValidateDBCompatibility($IntValue);
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:50: characters 9-76
	...
	public function SET ($IntValue) {
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:62: characters 9-55
		$asg = Assign::SET($this, Val::int($IntValue));
		#5_framework\orm\src/nMorph/framework/orm/common/fields/SmallIntegerSentence.hx:63: characters 9-19
		return $asg;
	}
...
Boot::registerClass(SmallIntegerSentence::class, 'nMorph.framework.orm.common.fields.SmallIntegerSentence');
