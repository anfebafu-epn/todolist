...
namespace nMorph\core\service\configuration;
...
class Initializer {
	...
	public static function Application_Start ($ConfigPath) {
		#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:16: characters 7-99
		$path = ($ConfigPath??'null') . "nMorph.framework.common.configuration.Configuration.config";
		\clearstatcache(true, $path);
		#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:16: lines 16-20
		if (\file_exists($path)) {
			#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:18: characters 4-161
			...
			#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:19: characters 4-134
			Configuration::ReadConfiguration($nMorph_framework_common_configuration_Configuration_Content);
		}
		#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:22: characters 7-96
		$path = ($ConfigPath??'null') . "nMorph.framework.orm.configuration.Configuration.config";
		\clearstatcache(true, $path);
		#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:22: lines 22-26
		if (\file_exists($path)) {
			#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:24: characters 4-155
			...
			#2_logic\service\src/nMorph/core/service/configuration/Initializer.hx:25: characters 4-128
...
Boot::registerClass(Initializer::class, 'nMorph.core.service.configuration.Initializer');
