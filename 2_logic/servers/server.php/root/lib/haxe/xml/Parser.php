...
class Parser {
	...
	public static function addSub ($buf, $s, $pos, $length) {
		#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:399: characters 10-59
	...
	public static function fastCodeAt ($s, $pos) {
		#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:391: characters 10-58
		if ($pos >= \strlen($s)) {
			#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:391: characters 36-37
			return 0;
		} else {
			#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:391: characters 40-58
			return \ord($s[$pos]);
		}
	}
	...
	public static function isValidChar ($c) {
		#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:383: lines 383-384
		if (!((($c >= 97) && ($c <= 122)) || (($c >= 65) && ($c <= 90)) || (($c >= 48) && ($c <= 57)) || ($c === 58) || ($c === 46) || ($c === 95))) {
			#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:384: characters 24-37
			return $c === 45;
		} else {
			#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:383: lines 383-384
			return true;
	...
	public static function substr ($s, $pos, $length = null) {
		#C:\HaxeToolkit\haxe\std/php/_std/haxe/xml/Parser.hx:395: characters 3-39
