...
class Serializer {
	...
	public static function run ($v) {
		#C:\HaxeToolkit\haxe\std/haxe/Serializer.hx:583: characters 3-28
		$s = new Serializer();
		#C:\HaxeToolkit\haxe\std/haxe/Serializer.hx:584: characters 3-17
		$s->serialize($v);
		#C:\HaxeToolkit\haxe\std/haxe/Serializer.hx:585: characters 3-22
		return $s->toString();
	}
	...
	public function serializeException ($e) {
		#C:\HaxeToolkit\haxe\std/haxe/Serializer.hx:560: characters 3-15
		$this->buf->add("x");
		#C:\HaxeToolkit\haxe\std/haxe/Serializer.hx:572: characters 3-15
		$this->serialize($e);
	}
