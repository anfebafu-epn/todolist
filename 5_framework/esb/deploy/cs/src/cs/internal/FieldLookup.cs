		protected static string[] fields = new string[]{"b", "h", "i", "m", "q", "s", "isGlobal", "__a", "add", "arr", "buf", "cur", "get", "idx", "key", "len", "map", "max", "min", "pop", "pos", "set", "str", "sub", "first", "resolveClass", "LogicModule", "split", "flags", "match", "compare", "stack", "start", "remove", "__previousException", "get_LogicClass", "filter", "set_LogicMethod", "hxUnserialize", "classString", "resize", "useCache", "matched", "getFullYear", "readString", "get_LogicMethod", "getHours", "isEmpty", "parseString", "resolver", "__nativeException", "getString", "getUTCMinutes", "LogicClass", "get_length", "setFloat", "methodName", "setDouble", "get_native", "iterator", "indent", "hxSerialize", "toHex", "dateUTC", "getData", "getDate", "getUInt16", "lastIndexOf", "getUTCSeconds", "serializeException", "get_LogFolder", "replacer", "hasNext", "message", "serializeFields", "reverse", "nOccupied", "parseNumber", "insert", "getInt32", "getInt64", "length", "addSub", "unserializeObject", "getTime", "get_message", "native", "getDay", "getMinutes", "previous", "useEnumIndex", "matchedRight", "set_LogicClass", "array", "invalidNumber", "getUTCDate", "invalidChar", "getSeconds", "serializeString", "replace", "details", "CurrentDeployEnvironment", "contains", "LogicParams", "readDigits", "pretty", "getDouble", "value", "quotient", "getResolver", "__nativeStack", "get_Name", "Name", "fieldsString", "cachedIndex", "toString", "hashes", "serializeRef", "scache", "setResolver", "set_LogicModule", "__exceptionStack", "splice", "exists", "args", "cache", "blit", "copy", "get_LogicModule", "date", "matchSub", "fill", "head", "scount", "ipad", "item", "getTimezoneOffset", "__skipStack", "join", "keys", "last", "get_stack", "concat", "clear", "newl", "next", "nind", "LogicMethod", "push", "keyValueIterator", "matchedPos", "current", "__shiftStack", "size", "setInt32", "setInt64", "sort", "quicksort", "getUTCDay", "vals", "write", "spliceVoid", "cachedKey", "readFloat", "LogFolder", "parseRec", "__ownStack", "getUTCMonth", "get_previous", "objString", "posInfos", "concatNative", "nBuckets", "set_LogFolder", "className", "quote", "resolveEnum", "offset", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "set_Name", "fileName", "getFloat", "toDynamic", "regex", "set_LogicParams", "getDefault", "getMonth", "unwrap", "nextChar", "get_CurrentDeployEnvironment", "get_LogicParams", "doParse", "set_CurrentDeployEnvironment", "__get", "__set", "__hx_deleteField", "serialize", "lineNumber", "getUTCHours", "modulus", "upperBound", "unshift", "setUInt16", "getUTCFullYear", "_keys", "unserialize", "shash", "shift", "matchedLeft", "addChar", "slice", "unserializeEnum"};
