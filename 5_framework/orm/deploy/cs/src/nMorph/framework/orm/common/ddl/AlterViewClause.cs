		...
		public virtual void SCRIPT_PART(string args) {
			unchecked {
				switch (this.CurrentDDL.getCurrentEngine()._hx_index) {
					case 0:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("ALTER VIEW \"", this.ViewName), "\" AS "));
					...
					case 1:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("CREATE OR REPLACE VIEW \"", this.ViewName), "\" AS "));
						this.CurrentDDL.AddBlock(this.InnerSQL.GenerateAll());
						break;
					}
					...
					case 3:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("DROP VIEW \"", this.ViewName), "\"; CREATE VIEW \""), this.ViewName), "\" AS "));
						this.CurrentDDL.AddBlock(this.InnerSQL.GenerateAll());
						break;
					}
