		...
		public virtual void SCRIPT_PART(string args) {
			unchecked {
				switch (this.CurrentDDL.getCurrentEngine()._hx_index) {
					case 0:
					{
						this.CurrentDDL.AddBlock(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("DROP CONSTRAINT \"PK", this.PrimaryKeyName), "\" "));
						break;
					}
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				switch (hash) {
					...
					case 13876232:
					{
						this.PrimaryKeyName = global::haxe.lang.Runtime.toString(@value);
						return @value;
					}
