		...
		public virtual void SCRIPT_PART(string args) {
			unchecked {
				...
				switch (this.CurrentDDL.getCurrentEngine()._hx_index) {
					case 0:
					{
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("SELECT COUNT(*) AS EXIST ", "FROM information_schema.tables "), "WHERE table_name=\'"));
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat(this.TableName, "\'"));
						break;
					}
					...
					case 1:
					{
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("select count(*) AS EXIST ", "from all_tables "), "where table_name= (\'"));
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat(this.TableName, "\')"));
						break;
					}
					...
					case 3:
					{
						Part = global::haxe.lang.Runtime.concat(Part, "SELECT ");
						break;
					}
					...
					case 4:
					{
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat("SELECT COUNT(CAST(table_name as varchar)) AS EXIST ", "FROM INFORMATION_SCHEMA.TABLES WHERE  table_name= \'"));
						Part = global::haxe.lang.Runtime.concat(Part, global::haxe.lang.Runtime.concat(this.TableName, "\'"));
						break;
					}
