...
namespace nMorph.framework.orm.common.clauses {
	public class OrderByClause : global::haxe.lang.HxObject, global::nMorph.framework.orm.interfaces.IClause {
		...
		public global::Array<object> OrderBySentences;
			...
			unchecked {
				...
				switch (this.CurrentSQL.getCurrentEngine()._hx_index) {
					case 0:
					{
						...
						{
							int _g = 0;
							global::Array<object> _g1 = this.OrderBySentences;
							while (( _g < _g1.length )) {
					...
					case 1:
					{
						...
						{
							int _g2 = 0;
							global::Array<object> _g3 = this.OrderBySentences;
					...
					case 2:
					{
						...
						{
							int _g4 = 0;
							global::Array<object> _g5 = this.OrderBySentences;
					...
					case 3:
					{
						...
						{
							int _g6 = 0;
							global::Array<object> _g7 = this.OrderBySentences;
					...
					case 4:
					{
						...
						{
							int _g8 = 0;
							global::Array<object> _g9 = this.OrderBySentences;
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				switch (hash) {
					case 1771930571:
					{
						this.OrderBySentences = ((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (@value) ))) );
						return @value;
					}
