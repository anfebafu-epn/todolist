...
public class CustomClause extends haxe.lang.HxObject implements nMorph.framework.orm.interfaces.IClause
{
	static
	{
		...
		nMorph.framework.orm.common.clauses.CustomClause.__rtti = new String("<class path=\"nMorph.framework.orm.common.clauses.CustomClause\" params=\"\">\n\t") + 
...
new String ("<CustomQueries><t path=\"Map\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<e path=\"nMorph.framework.orm.configuration.DatabaseEngineEnum\"/>\n</t></CustomQueries>\n\t") + 
new String ("<Parameters><c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueryParameter\"/></c></Parameters>\n\t") + 
new String ("<SCRIPT public=\"1\" set=\"method\" line=\"34\"><f a=\"\"><c path=\"String\"/></f></SCRIPT>\n\t") + 
new String ("<SCRIPT_PART public=\"1\" set=\"method\" line=\"39\"><f a=\"?args\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></SCRIPT_PART>\n\t") + 
new String ("<Execute public=\"1\" set=\"method\" line=\"58\"><f a=\"\"><d/></f></Execute>\n\t") + 
new String ("<Register public=\"1\" set=\"method\" line=\"63\"><f a=\"context\">\n\t") + 
...
new String ("<c path=\"nMorph.framework.orm.tools.BulkRun\"/>\n</f></Bulk>\n\t") + 
new String ("<ReadValue public=\"1\" set=\"method\" line=\"79\"><f a=\"\"><d/></f></ReadValue>\n\t") + 
new String ("<ReadTable public=\"1\" set=\"method\" line=\"84\"><f a=\"\"><c path=\"nMorph.framework.orm.client.QueryTable\"/></f></ReadTable>\n\t") + 
...
new String ("<ReadOne public=\"1\" params=\"T\" set=\"method\" line=\"94\"><f a=\"cl:?context\">\n\t") + 
new String ("<x path=\"Class\"><c path=\"ReadOne.T\"/></x>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.tools.Context\"/>\n\t") + 
new String ("<c path=\"ReadOne.T\"/>\n</f></ReadOne>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"27\"><f a=\"CurrentSQL:CustomQueries:?Parameters\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.lang.SQL\"/>\n\t") + 
new String ("<t path=\"Map\">\n\t") + 
new String ("\t<c path=\"String\"/>\n\t") + 
new String ("\t<e path=\"nMorph.framework.orm.configuration.DatabaseEngineEnum\"/>\n\t") + 
new String ("</t>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueryParameter\"/></c>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></new>\n\t") + 
new String ("<haxe_doc>* Cl\u00e1usula que permite la ejecuci\u00f3n de m\u00e9todos con la incorporaci\u00f3n de queries directos\n * @author Smartwork</haxe_doc>\n\t") + 
new String ("<meta>\n\t") + 
