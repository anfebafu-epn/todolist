...
public class QueryBlock extends haxe.lang.HxObject
{
	static
	{
		...
		nMorph.framework.orm.client.QueryBlock.__rtti = new String("<class path=\"nMorph.framework.orm.client.QueryBlock\" params=\"\">\n\t") + 
new String ("<SET public=\"1\" set=\"method\" line=\"17\" static=\"1\"><f a=\"BlockName:BlockCode\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.QueryBlock\"/>\n</f></SET>\n\t") + 
new String ("<BlockName public=\"1\" get=\"accessor\" set=\"accessor\">\n\t") + 
new String ("\t<c path=\"String\"/>\n\t") + 
new String ("\t<meta><m n=\":isVar\"/></meta>\n\t") + 
new String ("</BlockName>\n\t") + 
new String ("<get_BlockName set=\"method\" line=\"27\"><f a=\"\"><c path=\"String\"/></f></get_BlockName>\n\t") + 
new String ("<set_BlockName set=\"method\" line=\"32\"><f a=\"value\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n</f></set_BlockName>\n\t") + 
new String ("<BlockCode get=\"accessor\" set=\"accessor\">\n\t") + 
new String ("\t<c path=\"String\"/>\n\t") + 
new String ("\t<meta><m n=\":isVar\"/></meta>\n\t") + 
new String ("</BlockCode>\n\t") + 
new String ("<get_BlockCode set=\"method\" line=\"40\"><f a=\"\"><c path=\"String\"/></f></get_BlockCode>\n\t") + 
new String ("<set_BlockCode set=\"method\" line=\"45\"><f a=\"value\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n</f></set_BlockCode>\n\t") + 
