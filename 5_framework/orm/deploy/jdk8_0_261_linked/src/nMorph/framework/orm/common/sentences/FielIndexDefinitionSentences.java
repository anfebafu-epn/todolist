...
public class FielIndexDefinitionSentences extends haxe.lang.HxObject implements nMorph.framework.orm.interfaces.ISentence
{
	static
	{
		...
		nMorph.framework.orm.common.sentences.FielIndexDefinitionSentences.__rtti = new String("<class path=\"nMorph.framework.orm.common.sentences.FielIndexDefinitionSentences\" params=\"\">\n\t") + 
...
new String ("<CurrentDDL public=\"1\" get=\"accessor\" set=\"null\">\n\t") + 
new String ("\t<c path=\"nMorph.framework.orm.lang.DDL\"/>\n\t") + 
new String ("\t<meta><m n=\":isVar\"/></meta>\n\t") + 
new String ("</CurrentDDL>\n\t") + 
new String ("<RegisterQuery public=\"1\" set=\"method\" line=\"23\"><f a=\"CurrentDDL\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.interfaces.ILang\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></RegisterQuery>\n\t") + 
new String ("<IsNullValue public=\"1\" set=\"method\" line=\"28\"><f a=\"\"><x path=\"Bool\"/></f></IsNullValue>\n\t") + 
new String ("<get_FieldName set=\"method\" line=\"33\"><f a=\"\"><c path=\"String\"/></f></get_FieldName>\n\t") + 
new String ("<get_FieldTable set=\"method\" line=\"38\"><f a=\"\"><c path=\"String\"/></f></get_FieldTable>\n\t") + 
new String ("<get_CurrentDDL set=\"method\" line=\"43\"><f a=\"\"><c path=\"nMorph.framework.orm.lang.DDL\"/></f></get_CurrentDDL>\n\t") + 
new String ("<SCRIPT_PART public=\"1\" set=\"method\" line=\"47\"><f a=\"?args\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></SCRIPT_PART>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"17\"><f a=\"FieldTable:FieldName\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></new>\n\t") + 
new String ("<meta>\n\t") + 
