...
public class HavingClause extends haxe.lang.HxObject implements nMorph.framework.orm.interfaces.IClause
{
	static
	{
		...
		nMorph.framework.orm.common.clauses.HavingClause.__rtti = new String("<class path=\"nMorph.framework.orm.common.clauses.HavingClause\" params=\"\">\n\t") + 
...
new String ("<HavingCondition><c path=\"nMorph.framework.orm.interfaces.ICondition\"/></HavingCondition>\n\t") + 
new String ("<ORDERBY public=\"1\" set=\"method\" line=\"28\"><f a=\"OrderBySentences\">\n\t") + 
...
new String ("<UNION public=\"1\" set=\"method\" line=\"34\"><f a=\"UnionType:Clause\">\n\t") + 
...
new String ("<SCRIPT public=\"1\" set=\"method\" line=\"40\"><f a=\"\"><c path=\"String\"/></f></SCRIPT>\n\t") + 
new String ("<SCRIPT_PART public=\"1\" set=\"method\" line=\"44\"><f a=\"?args\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></SCRIPT_PART>\n\t") + 
new String ("<Execute public=\"1\" set=\"method\" line=\"64\"><f a=\"\"><d/></f></Execute>\n\t") + 
new String ("<Register public=\"1\" set=\"method\" line=\"68\"><f a=\"context\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.tools.Context\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></Register>\n\t") + 
new String ("<Queue public=\"1\" set=\"method\" line=\"72\"><f a=\"queue\">\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n</f></Queue>\n\t") + 
new String ("<Bulk public=\"1\" set=\"method\" line=\"76\"><f a=\"bulk\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.tools.BulkRun\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.tools.BulkRun\"/>\n</f></Bulk>\n\t") + 
new String ("<ReadValue public=\"1\" set=\"method\" line=\"81\"><f a=\"\"><d/></f></ReadValue>\n\t") + 
new String ("<ReadTable public=\"1\" set=\"method\" line=\"85\"><f a=\"\"><c path=\"nMorph.framework.orm.client.QueryTable\"/></f></ReadTable>\n\t") + 
new String ("<Read public=\"1\" params=\"T\" set=\"method\" line=\"89\"><f a=\"cl:?context\">\n\t") + 
...
new String ("<new public=\"1\" set=\"method\" line=\"22\"><f a=\"CurrentSQL:HavingCondition\">\n\t") + 
