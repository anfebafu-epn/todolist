...
public class DateTimeSentence extends nMorph.framework.orm.common.sentences.FieldSentence
{
	static
	{
		...
		nMorph.framework.orm.common.fields.DateTimeSentence.__rtti = new String("<class path=\"nMorph.framework.orm.common.fields.DateTimeSentence\" params=\"\">\n\t") + 
new String ("<extends path=\"nMorph.framework.orm.common.sentences.FieldSentence\"/>\n\t") + 
new String ("<ValidateDBCompatibility public=\"1\" set=\"method\" line=\"20\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></ValidateDBCompatibility>\n\t") + 
new String ("<Equals public=\"1\" set=\"method\" line=\"30\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></Equals>\n\t") + 
new String ("<Different public=\"1\" set=\"method\" line=\"35\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></Different>\n\t") + 
new String ("<LessThan public=\"1\" set=\"method\" line=\"40\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></LessThan>\n\t") + 
new String ("<LessThanAndEquals public=\"1\" set=\"method\" line=\"45\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></LessThanAndEquals>\n\t") + 
new String ("<MoreThan public=\"1\" set=\"method\" line=\"50\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></MoreThan>\n\t") + 
new String ("<MoreThanAndEquals public=\"1\" set=\"method\" line=\"55\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></MoreThanAndEquals>\n\t") + 
new String ("<IsNull public=\"1\" set=\"method\" line=\"60\"><f a=\"\"><c path=\"nMorph.framework.orm.common.conditions.Condition\"/></f></IsNull>\n\t") + 
new String ("<IsNotNull public=\"1\" set=\"method\" line=\"64\"><f a=\"\"><c path=\"nMorph.framework.orm.common.conditions.Condition\"/></f></IsNotNull>\n\t") + 
new String ("<SET public=\"1\" set=\"method\" line=\"68\"><f a=\"DateValue\">\n\t") + 
new String ("<c path=\"Date\"/>\n\t") + 
