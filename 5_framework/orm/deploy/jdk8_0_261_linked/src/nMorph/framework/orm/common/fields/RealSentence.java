...
public class RealSentence extends nMorph.framework.orm.common.sentences.FieldSentence
{
	static
	{
		...
		nMorph.framework.orm.common.fields.RealSentence.__rtti = new String("<class path=\"nMorph.framework.orm.common.fields.RealSentence\" params=\"\">\n\t") + 
new String ("<extends path=\"nMorph.framework.orm.common.sentences.FieldSentence\"/>\n\t") + 
new String ("<ValidateDBCompatibility public=\"1\" set=\"method\" line=\"19\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></ValidateDBCompatibility>\n\t") + 
new String ("<Equals public=\"1\" set=\"method\" line=\"23\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></Equals>\n\t") + 
new String ("<Different public=\"1\" set=\"method\" line=\"28\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></Different>\n\t") + 
new String ("<LessThan public=\"1\" set=\"method\" line=\"33\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></LessThan>\n\t") + 
new String ("<LessThanAndEquals public=\"1\" set=\"method\" line=\"38\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></LessThanAndEquals>\n\t") + 
new String ("<MoreThan public=\"1\" set=\"method\" line=\"43\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></MoreThan>\n\t") + 
new String ("<MoreThanAndEquals public=\"1\" set=\"method\" line=\"48\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></MoreThanAndEquals>\n\t") + 
...
new String ("<SET public=\"1\" set=\"method\" line=\"61\"><f a=\"FloatValue\">\n\t") + 
new String ("<x path=\"Float\"/>\n\t") + 
