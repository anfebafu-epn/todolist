...
public class BigTextSentence extends nMorph.framework.orm.common.sentences.FieldSentence
{
	static
	{
		...
		nMorph.framework.orm.common.fields.BigTextSentence.__rtti = new String("<class path=\"nMorph.framework.orm.common.fields.BigTextSentence\" params=\"\">\n\t") + 
new String ("<extends path=\"nMorph.framework.orm.common.sentences.FieldSentence\"/>\n\t") + 
new String ("<ValidateDBCompatibility public=\"1\" set=\"method\" line=\"20\"><f a=\"stringValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></ValidateDBCompatibility>\n\t") + 
new String ("<Equals public=\"1\" set=\"method\" line=\"26\"><f a=\"stringValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></Equals>\n\t") + 
new String ("<LIKE public=\"1\" set=\"method\" line=\"31\"><f a=\"stringValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></LIKE>\n\t") + 
new String ("<NotLIKE public=\"1\" set=\"method\" line=\"36\"><f a=\"stringValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.common.conditions.Condition\"/>\n</f></NotLIKE>\n\t") + 
new String ("<IsNull public=\"1\" set=\"method\" line=\"41\"><f a=\"\"><c path=\"nMorph.framework.orm.common.conditions.Condition\"/></f></IsNull>\n\t") + 
new String ("<IsNotNull public=\"1\" set=\"method\" line=\"45\"><f a=\"\"><c path=\"nMorph.framework.orm.common.conditions.Condition\"/></f></IsNotNull>\n\t") + 
new String ("<SET public=\"1\" set=\"method\" line=\"49\"><f a=\"stringValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.interfaces.ISet\"/>\n</f></SET>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"16\"><f a=\"FieldTable:FieldName:Nullable:IsPrimaryKey\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
