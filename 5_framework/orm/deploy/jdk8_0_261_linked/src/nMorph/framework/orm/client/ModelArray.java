...
public class ModelArray<T> extends haxe.lang.HxObject
{
	static
	{
		...
		nMorph.framework.orm.client.ModelArray.__rtti = new String("<class path=\"nMorph.framework.orm.client.ModelArray\" params=\"T\">\n\t") + 
new String ("<arr public=\"1\" get=\"accessor\" set=\"accessor\">\n\t") + 
new String ("\t<c path=\"Array\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></c>\n\t") + 
new String ("\t<meta><m n=\":isVar\"/></meta>\n\t") + 
new String ("</arr>\n\t") + 
new String ("<set_arr set=\"method\" line=\"18\"><f a=\"value\">\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></c>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></c>\n</f></set_arr>\n\t") + 
new String ("<get_arr set=\"method\" line=\"23\"><f a=\"\"><c path=\"Array\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></c></f></get_arr>\n\t") + 
new String ("<Include public=\"1\" set=\"method\" line=\"38\"><f a=\"clause:laClase:context\">\n\t") + 
...
new String ("<Add public=\"1\" set=\"method\" line=\"65\"><f a=\"x\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.ModelArray.T\"/>\n\t") + 
new String ("<x path=\"Int\"/>\n</f></Add>\n\t") + 
new String ("<Remove public=\"1\" set=\"method\" line=\"74\"><f a=\"x\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.ModelArray.T\"/>\n\t") + 
new String ("<x path=\"Bool\"/>\n</f></Remove>\n\t") + 
new String ("<Insert public=\"1\" set=\"method\" line=\"88\"><f a=\"pos:x\">\n\t") + 
new String ("<x path=\"Int\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.ModelArray.T\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></Insert>\n\t") + 
new String ("<Filter public=\"1\" set=\"method\" line=\"93\"><f a=\"f\">\n\t") + 
new String ("<f a=\"\">\n\t") + 
new String ("\t<c path=\"nMorph.framework.orm.client.ModelArray.T\"/>\n\t") + 
new String ("\t<x path=\"Bool\"/>\n\t") + 
new String ("</f>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></c>\n</f></Filter>\n\t") + 
new String ("<iterator public=\"1\" set=\"method\" line=\"98\"><f a=\"\"><t path=\"Iterator\"><c path=\"nMorph.framework.orm.client.ModelArray.T\"/></t></f></iterator>\n\t") + 
new String ("<Save public=\"1\" set=\"method\" line=\"103\"><f a=\"queue\">\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n</f></Save>\n\t") + 
new String ("<Clear public=\"1\" set=\"method\" line=\"116\"><f a=\"\"><x path=\"Void\"/></f></Clear>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"138\"><f a=\"\"><x path=\"Void\"/></f></new>\n\t") + 
new String ("<meta>\n\t") + 
