...
public class ModelItem<T> extends haxe.lang.HxObject
{
	static
	{
		...
		nMorph.framework.orm.client.ModelItem.__rtti = new String("<class path=\"nMorph.framework.orm.client.ModelItem\" params=\"T\">\n\t") + 
new String ("<it public=\"1\" get=\"accessor\" set=\"accessor\">\n\t") + 
new String ("\t<c path=\"nMorph.framework.orm.client.ModelItem.T\"/>\n\t") + 
new String ("\t<meta><m n=\":isVar\"/></meta>\n\t") + 
new String ("</it>\n\t") + 
new String ("<set_it set=\"method\" line=\"17\"><f a=\"value\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.ModelItem.T\"/>\n\t") + 
new String ("<c path=\"nMorph.framework.orm.client.ModelItem.T\"/>\n</f></set_it>\n\t") + 
new String ("<get_it set=\"method\" line=\"21\"><f a=\"\"><c path=\"nMorph.framework.orm.client.ModelItem.T\"/></f></get_it>\n\t") + 
new String ("<Include public=\"1\" set=\"method\" line=\"26\"><f a=\"clause:laClase:context\">\n\t") + 
...
new String ("<Save public=\"1\" set=\"method\" line=\"49\"><f a=\"queue\">\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n\t") + 
new String ("<c path=\"Array\"><c path=\"nMorph.framework.orm.client.QueueItem\"/></c>\n</f></Save>\n\t") + 
new String ("<Clear public=\"1\" set=\"method\" line=\"58\"><f a=\"\"><x path=\"Void\"/></f></Clear>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"66\"><f a=\"\"><x path=\"Void\"/></f></new>\n\t") + 
new String ("<meta>\n\t") + 
