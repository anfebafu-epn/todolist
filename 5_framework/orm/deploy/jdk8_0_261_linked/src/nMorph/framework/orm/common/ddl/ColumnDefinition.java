...
public class ColumnDefinition extends haxe.lang.HxObject implements nMorph.framework.orm.interfaces.IColumnDefinition
{
	static
	{
		...
		nMorph.framework.orm.common.ddl.ColumnDefinition.__rtti = new String("<class path=\"nMorph.framework.orm.common.ddl.ColumnDefinition\" params=\"\">\n\t") + 
new String ("<implements path=\"nMorph.framework.orm.interfaces.IColumnDefinition\"/>\n\t") + 
new String ("<SET public=\"1\" set=\"method\" line=\"34\" static=\"1\"><f a=\"ColumnName:DataType:Lenght:Scale:Nullable:IsPrimaryKey:DefaultValue\">\n\t") + 
...
new String ("<c path=\"nMorph.framework.orm.common.ddl.ColumnDefinition\"/>\n</f></SET>\n\t") + 
new String ("<ColumnName><c path=\"String\"/></ColumnName>\n\t") + 
new String ("<DataType><e path=\"nMorph.framework.orm.common.enums.DBTypeEnum\"/></DataType>\n\t") + 
new String ("<Lenght><x path=\"Int\"/></Lenght>\n\t") + 
new String ("<Scale><x path=\"Int\"/></Scale>\n\t") + 
new String ("<Nullable><e path=\"nMorph.framework.orm.common.enums.NullableEnum\"/></Nullable>\n\t") + 
new String ("<IsPrimaryKey><x path=\"Bool\"/></IsPrimaryKey>\n\t") + 
new String ("<DefaultValue><c path=\"nMorph.framework.orm.interfaces.IColumnDefinition\"/></DefaultValue>\n\t") + 
new String ("<CurrentDDL><c path=\"nMorph.framework.orm.lang.DDL\"/></CurrentDDL>\n\t") + 
new String ("<RegisterQuery public=\"1\" set=\"method\" line=\"39\"><f a=\"CurrentDDL\">\n\t") + 
new String ("<c path=\"nMorph.framework.orm.interfaces.ILang\"/>\n\t") + 
new String ("<x path=\"Void\"/>\n</f></RegisterQuery>\n\t") + 
new String ("<SCRIPT_PART public=\"1\" set=\"method\" line=\"43\"><f a=\"?args\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<c path=\"String\"/>\n</f></SCRIPT_PART>\n\t") + 
new String ("<new public=\"1\" set=\"method\" line=\"24\"><f a=\"ColumnName:DataType:Lenght:Scale:Nullable:IsPrimaryKey:DefaultValue\">\n\t") + 
new String ("<c path=\"String\"/>\n\t") + 
new String ("<e path=\"nMorph.framework.orm.common.enums.DBTypeEnum\"/>\n\t") + 
new String ("<x path=\"Int\"/>\n\t") + 
new String ("<x path=\"Int\"/>\n\t") + 
