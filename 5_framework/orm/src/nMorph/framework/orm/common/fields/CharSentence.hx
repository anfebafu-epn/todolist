...
class CharSentence extends FieldSentence {
    ...
    public function new(FieldTable:String, FieldName:String, Length:Int, Nullable:NullableEnum, IsPrimaryKey:Bool) {
        super(FieldTable, FieldName, DBTypeEnum.CHAR, HaxeTypeEnum.STRING, Length, null, Nullable, IsPrimaryKey);
    }
