...
class CreateIndexClause implements IClause {
    ...
    private var Columns:FielIndexDefinitionSentences;

    public function new(CurrentDDL:DDL, IndexName:String, Columns:FielIndexDefinitionSentences) {
    ...
    public function SCRIPT_PART(?args:String) {
        ...
        switch(CurrentDDL.getCurrentEngine()){
            case DatabaseEngineEnum.GENERIC:
                ...
                CurrentDDL.AddBlock("CREATE INDEX \"" + IndexName + "\" ON ");
                Columns.SCRIPT_PART();
