...
final class AttribAccess_Impl_ {
	...
	public static function _hx_set ($this1, $name, $value) {
		#C:\HaxeToolkit\haxe\std/haxe/xml/Access.hx:50: lines 50-51
		if ($this1->nodeType === \Xml::$Document) {
			#C:\HaxeToolkit\haxe\std/haxe/xml/Access.hx:51: characters 4-9
			throw Exception::thrown("Cannot access document attribute " . ($name??'null'));
		}
		#C:\HaxeToolkit\haxe\std/haxe/xml/Access.hx:52: characters 3-24
		$this1->set($name, $value);
		#C:\HaxeToolkit\haxe\std/haxe/xml/Access.hx:53: characters 3-15
		return $value;
	}
