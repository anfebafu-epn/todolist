...
namespace nMorph.framework.orm.common.clauses {
	public class SelectClause : global::haxe.lang.HxObject, global::nMorph.framework.orm.interfaces.IClause {
			...
			__hx_this.Sentences = new global::Array<object>();
			{
				...
				__hx_this.Sentences = Sentences;
				{
					...
					while (( _g < Sentences.length )) {
						global::nMorph.framework.orm.interfaces.ISentence s = ((global::nMorph.framework.orm.interfaces.ISentence) (Sentences[_g]) );
						 ++ _g;
		...
		public global::Array<object> Sentences;
				...
				switch (this.CurrentSQL.getCurrentEngine()._hx_index) {
					case 0:
					{
						...
						if (( this.Sentences.length == 0 )) {
							...
							{
								int _g = 0;
								global::Array<object> _g1 = this.Sentences;
								while (( _g < _g1.length )) {
					...
					case 1:
					{
						...
						if (( this.Sentences.length == 0 )) {
							...
							{
								int _g2 = 0;
								global::Array<object> _g3 = this.Sentences;
					...
					case 2:
					{
						...
						if (( this.Sentences.length == 0 )) {
							...
							{
								int _g4 = 0;
								global::Array<object> _g5 = this.Sentences;
					...
					case 3:
					{
						...
						if (( this.Sentences.length == 0 )) {
							...
							{
								int _g6 = 0;
								global::Array<object> _g7 = this.Sentences;
					...
					case 4:
					{
						...
						if (( this.Sentences.length == 0 )) {
							...
							{
								int _g8 = 0;
								global::Array<object> _g9 = this.Sentences;
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				switch (hash) {
					case 625244752:
					{
						this.Sentences = ((global::Array<object>) (global::Array<object>.__hx_cast<object>(((global::Array) (@value) ))) );
						return @value;
					}
