    ...
    export class Index {
            ...
            head.load("config.js?v=" + new Date().getTime().toString(), // Hace que este archivo nunca haga caché, siempre lea la última configuración
                function () {
                    head.load(
                        ...
                        "index.css?v=" + current_version,
                        "index.js?v=" + current_version,
                        function () {
                            Index.Load();
                        });
                }
        ...
        static Load() {
            ...
            $('#btn_Login').click(() => {
                ...
                ui.assets.js.Proxy.Person_Login(email, pass, (n: nMorph.core.db.sw_todolist.Person) => {
                    if (n == null) {
            ...
            $('#btn_Reset').click(() => {
                ui.assets.js.Proxy.Query((n: string) => {
                    alert(n);
                });
