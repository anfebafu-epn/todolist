...
class PosException extends Exception {
	...
	public function __construct ($message, $previous = null, $pos = null) {
		#C:\HaxeToolkit\haxe\std/haxe/exceptions/PosException.hx:13: characters 3-27
		parent::__construct($message, $previous);
		#C:\HaxeToolkit\haxe\std/haxe/exceptions/PosException.hx:14: lines 14-18
		if ($pos === null) {
			#C:\HaxeToolkit\haxe\std/haxe/exceptions/PosException.hx:15: characters 4-100
			$this->posInfos = new _HxAnon_PosException0("(unknown)", 0, "(unknown)", "(unknown)");
		} else {
			#C:\HaxeToolkit\haxe\std/haxe/exceptions/PosException.hx:17: characters 4-18
			$this->posInfos = $pos;
		}
	}
	...
	public function toString () {
		#C:\HaxeToolkit\haxe\std/haxe/exceptions/PosException.hx:25: characters 3-126
